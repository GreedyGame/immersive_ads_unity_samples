...
namespace PubScale.SdkOne.NativeAds.Hightower
{
    ...
    public class NativeCompanion : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            NativeAdClickDisabler.customAdShowHide += NativeAdClickDisabler_customAdShowHide;
        }

        private void NativeAdClickDisabler_customAdShowHide(bool obj)
        {
            if (obj)
                companionDisplay.gameObject.SetActive(false);
            else
                companionDisplay.gameObject.SetActive(true);
        }
